...
<section class="banner-style-two centred">
            <div class="banner-carousel owl-theme owl-carousel owl-nav-none">
                <div class="slide-item">
                    <div class="image-layer" style="background-image: url({{ asset('frontend/assets/images/banner/img-1.jpg') }})"></div>
                    <div class="auto-container"><br><br><br>
                ...
                <div class="slide-item">
                    <div class="image-layer" style="background-image: url({{ asset('frontend/assets/images/banner/img-6.jpg') }})"></div>
                ...
                <div class="slide-item">
                    <div class="image-layer" style="background-image: url({{ asset('frontend/assets/images/banner/img-7.jpg') }})"></div>
                    <div class="auto-container">
                        <div class="content-box"><br><br><br>
                        <h2>Create Lasting Wealth Through RealEstate</h2>
                        <p>Elevate Your Living Experience with Us Where Every Key Opens Possibilities.</p>
