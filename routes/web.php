...
Route::middleware(['auth', 'roles:admin'])->group(function () {
     ...
     Route::controller(PropertyController::class)->group(function () {
          ...
          Route::get('/price/filter', 'priceFilter')->name('price.filter');
     });
...
Route::get('/buy/property', [PropertyController::class, 'BuyProperty'])->name('buy.property');
Route::get('/price/filter', [PropertyController::class, 'priceFilter'])->name('price.filter');
Route::get('front/all/property', [IndexController::class, 'AllProperty'])->name('front.all.property');
